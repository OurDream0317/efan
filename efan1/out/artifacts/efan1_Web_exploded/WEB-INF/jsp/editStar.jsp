...
编辑明星
<br><br>
<form action="<%=path%>/star/editStarDemo" method="post" enctype="multipart/form-data">
    ...
    <input type="submit" value="确定" style="width: 100px;height: 40px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="width: 100px;height: 40px" onclick="window.history.back(-1)">取消</button>
</form>
</body>
</html>
