...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            var manay=0;
              /*可以获取登录的信息*/
            console.log(${activeUser.managestatus}+"=======123456")
            ...
            $.get("selectordernotAll", {
                ...
                "manageacc":"${activeUser.manageacc}",
                "managestatus":${activeUser.managestatus},
                ...
                for( var i = 0; i < data.length; i++ ) {
                    ...
                    html += "<td>" +data[i].orderDatailList[0].showList[0].showtitle + "</td>";
                    html += "<td>" + manay+ "</td>";
                    html += "<td>" +data[i].orderDatailList[0].showList[0].showperson + "</td>";
                    ...
                    var u= "orderdetail?ordernumber="+data[i].ordernumber;
                    var u2= "updatenotestatus?ordernumber="+data[i].ordernumber;
                ...
                $.get("selectordernotAll", {
                    ...
                    if(data.length===0&&currentpage!=1){
                        ...
                        for( var i = 0; i < data.length; i++ ) {
                            ...
                            var u= "orderdetail?ordernumber="+data[i].cattleid;
                            var u2= "updatenotestatus?ordernumber="+data[i].cattleid;
                            if(data[i].orderstatus==2){
                                html += "<td> <a class=link_icon  href="+u+">查看详情</a>&nbsp;&nbsp;&nbsp;&nbsp; <a class=link_icon  onclick='prom("+data[i].ordernumber+")'>发货</a> </td>";
        ...
        function hide2(){
            ...
            if(express==="请输入物流公司"){
                ...
                if(expressnumber==="请输入物流单号"){
                  ...
                  /*  $.get("updatenotestatus",{"ordernumber":ordernumber,
                        "express":express,
                        "expressnumber":expressnumber
                        });*/
                    var nextPage="updatenotestatus?ordernumber="+ordernumber+"&express="+express+"&expressnumber="+expressnumber;
