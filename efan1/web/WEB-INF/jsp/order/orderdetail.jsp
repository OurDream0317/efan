...
<table width="100%" border=1 class="table" id="mytab">
    ...
    <tr>
        <td>${detail.showList[0].showtitle}</td>
        <td>${detail.showList[0].showperson}</td>
        <td>${detail.buynumber}</td>
        <td>${detail.price}</td>

        <td><a href="<%=basePath%>show/viewShowDemo?showid=${detail.showList[0].showid}">查看</a></td>
    </tr>
...
<h4>物流信息</h4>
<div>
    <tr><td><span>物流名称:</span></td>&nbsp;&nbsp;&nbsp;&nbsp;<td><span id="ddd3">${order.express}</span></td></tr><br><br>
    <tr><td><span>物流单号:</span></td>&nbsp;&nbsp;&nbsp;&nbsp;<td><span id="ddd4">${order.expressnumber}</span></td></tr><br><br>
</div>
</c:forEach>
<tr><td></td>&nbsp;&nbsp;&nbsp;&nbsp;<td><a href="<%=basePath%>order/ordernote"><button style="width: 100px;height: 35px;color:#333;"> 返回</button></a></td></tr><br><br>
