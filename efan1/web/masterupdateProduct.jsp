...
<div style="width:60%; height:600px; margin-left: auto;margin-right: auto;background: #c0c0c0;overflow-y: auto;margin-bottom: 50px;">
    ...
    <br>
    <h3 style="width: auto;height: 30px;line-height: 30px;background: #C3DEF9">商品更新:</h3>

                           <span style="color: red;">${msg}</span>

    <form action="<%=basePath%>master/masterupdateproduct" method="post" enctype="multipart/form-data">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="width: 90px;height: 25px; ">商品id：</span>&nbsp;<input name="proid"  value="${proid}" type="text" readonly="readonly" style="width:200px;height: 30px; margin-bottom: 5px;">
        <br>
        ...
        <br><br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" value="确定" style="width: 100px;height: 40px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
